#!/bin/bash
#SBATCH --job-name=msa_calc       # Job name
...
python mmseqs_query.py --split /cbica/home/shahroha/projects/AF-DIT/atlas/atlas.csv --outdir /cbica/home/shahroha/projects/AF-DIT/atlas/MSA
~